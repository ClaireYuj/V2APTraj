...
def get_parser():
    ...
    parser.add_argument("--pass_time",
                        default=2,
                        type=int)
    parser.add_argument("--taxi_pass_time", default=10, type=int, help="car pass time")
    ...
    parser.add_argument('--x_encoder_layers', type=int, default=3,
    ...
    parser.add_argument(
        ...
        help='defalut 0, set in the util.self.data_dirs')
    parser.add_argument(
        '--base_dir', default='.',
    ...
    parser.add_argument(
        '--save_base_dir', default='./save_dir/',
        help='Directory for saving caches and models.')
    parser.add_argument(
        '--phase', default='train',
